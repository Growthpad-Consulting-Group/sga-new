...
export const metadata = {
  title: 'Events & Venues Security - SGA Security Tanzania',
  description: 'Professional event security services for concerts, conferences, sports events, and venues in Tanzania. Ensuring safe and secure experiences for attendees and organizers.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Professional event security services for concerts, conferences, sports events, and venues across Tanzania. We ensure safe and secure experiences for attendees and organizers."
        ...
        relatedServices={[
          {
            ...
            link: '/tz/services/corporate/event-security',
          },
          {
