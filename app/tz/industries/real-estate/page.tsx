...
export const metadata = {
  title: 'Real Estate & Offices Security - SGA Security Tanzania',
  description: 'Comprehensive security solutions for office buildings, commercial properties, and real estate developments in Tanzania. Protecting tenants, assets, and property value with professional security services.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Comprehensive security solutions for office buildings, commercial properties, and real estate developments across Tanzania. We protect tenants, assets, and property value with professional security services."
        ...
        relatedServices={[
          ...
          },
          {
            ...
            link: '/tz/services/alarm-response',
          },
        ]}
      />
      <FloatingWhatsApp 
