...
export const metadata = {
  title: 'Residential Estates & Apartments Security - SGA Security Tanzania',
  description: 'Comprehensive security solutions for gated communities, residential estates, and apartment complexes in Tanzania. 24/7 guarding, access control, CCTV monitoring, and rapid response.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Comprehensive security solutions for gated communities, residential estates, and apartment complexes across Tanzania. We provide round-the-clock protection that gives residents peace of mind."
