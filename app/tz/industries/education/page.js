...
export const metadata = {
  title: 'Education & Schools Security - SGA Security Tanzania',
  description: 'Specialized security services for schools, colleges, and universities in Tanzania. Ensuring safe learning environments for students and staff with campus security and student safety programs.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroTitle="Protecting Tanzania's Future Leaders"
        heroDescription="Specialized security services for educational institutions across Tanzania. We create safe learning environments where students can focus on their education without security concerns."
