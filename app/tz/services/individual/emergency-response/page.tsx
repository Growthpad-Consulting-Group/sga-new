...
export const metadata = {
  title: 'Emergency Response Services - SGA Security Tanzania',
  description: '24/7 rapid response teams ready to handle security incidents immediately in Tanzania. Professional emergency response services.',
}
  ...
  return (
    <>
      <ServicePageTemplate countryCode="tz" 
        ...
        heroDescription="Our emergency response service provides 24/7 rapid deployment of trained response teams to handle security incidents immediately. When emergencies occur, our teams are ready to respond quickly and professionally across Tanzania."
        ...
        relatedServices={[
          ...
          },
          {
            ...
            link: '/tz/services/personal-panic-app',
          },
        ]}
      />
      <FloatingWhatsApp 
