...
export const metadata = {
  title: 'Home Security Services - SGA Security Tanzania',
  description: 'Comprehensive home security solutions to protect your family and property in Tanzania. 24/7 monitoring and rapid response services.',
}
  ...
  return (
    <>
      <ServicePageTemplate countryCode="tz" 
        ...
        heroDescription="Our comprehensive home security solutions provide complete protection for your residence, family, and valuables. With advanced technology and professional monitoring, we ensure your home is secure 24/7 across Tanzania."
        ...
        relatedServices={[
          ...
          },
          {
            ...
            link: '/tz/services/individual/safe-home-packages',
          },
          {
