...
export const metadata = {
  title: 'Electronic Security Services - SGA Security Tanzania',
  description: 'Advanced electronic security systems for businesses in Tanzania. CCTV surveillance, access control, and alarm systems for comprehensive corporate protection.',
}
  ...
  return (
    <>
      <ServicePageTemplate countryCode="tz" 
        ...
        heroDescription="Our electronic security solutions provide comprehensive protection for your business through advanced surveillance, access control, and alarm systems. With cutting-edge technology and professional installation, we ensure your corporate assets are secure across Tanzania."
