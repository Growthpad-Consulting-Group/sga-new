...
const foundations = [
  {
    title: 'Mission',
    longDescription: 'To provide sustainable safety and security solutions in Tanzania built on exceptional people, innovative technology, and unwavering responsibility to our clients and communities.',
    imageUrl: '/images/group/about/vision.png',
  },
  {
    title: 'Vision',
    longDescription: 'To be Tanzania\'s most trusted security solutions provider, recognized for excellence, innovation, and our unwavering commitment to protecting what matters most to Tanzanians. We envision a future where businesses and communities across Tanzania feel safe and secure, enabled by our comprehensive security services.',
    imageUrl: '/images/group/about/vision.png',
  },
  {
    title: 'Values',
    longDescription: 'Integrity, excellence, innovation, and social responsibility form the foundation of our values in Tanzania. We operate with transparency and ethical standards, continuously improving our services, embracing technological advancements, and giving back to Tanzanian communities. These values shape our culture and define how we interact with clients, partners, and each other.',
...
export default function OurFoundation({ 
  ...
  description = "Built on the pillars that define who we are and drive our commitment to excellence in Tanzania."
}) {
