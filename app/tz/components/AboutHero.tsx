    ...
    <section id="hero" className="bg-gray-100 text-dark-charcoal pt-32 sm:pt-40 lg:pt-48 pb-0">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed max-w-2xl">Comprehensive security solutions protecting businesses and communities across Tanzania.</p>
        </motion.div>
      </div>
