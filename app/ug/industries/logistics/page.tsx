...
export const metadata = {
  title: 'Logistics & Transportation Security - SGA Security Uganda',
  description: 'Security services for logistics companies, warehouses, and transportation hubs in Uganda. Protecting goods in transit and securing distribution centers.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Comprehensive security solutions for logistics companies, warehouses, and transportation hubs across Uganda. We protect goods in transit and secure distribution centers."
