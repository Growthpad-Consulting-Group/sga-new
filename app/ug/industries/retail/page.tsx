...
export const metadata = {
  title: 'Retail & Commerce Security - SGA Security Uganda',
  description: 'Retail security services protecting shops, malls, and commercial establishments in Uganda. Reducing theft, ensuring customer safety, and maintaining secure business operations.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Comprehensive retail security services for shops, malls, and commercial establishments across Uganda. We help reduce theft, ensure customer safety, and maintain secure business operations."
