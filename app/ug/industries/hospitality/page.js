...
export const metadata = {
  title: 'Hospitality & Holiday Homes Security - SGA Security Uganda',
  description: 'Security solutions for hotels, resorts, and holiday properties in Uganda. Ensuring guest safety and protecting hospitality assets with discreet, professional security services.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Professional security services for hotels, resorts, and holiday properties across Uganda. We ensure guest safety while maintaining the welcoming atmosphere that defines exceptional hospitality."
