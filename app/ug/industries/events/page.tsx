...
export const metadata = {
  title: 'Events & Venues Security - SGA Security Uganda',
  description: 'Professional event security services for concerts, conferences, sports events, and venues in Uganda. Ensuring safe and secure experiences for attendees and organizers.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Professional event security services for concerts, conferences, sports events, and venues across Uganda. We ensure safe and secure experiences for attendees and organizers."
