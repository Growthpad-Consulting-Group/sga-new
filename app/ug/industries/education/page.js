...
export const metadata = {
  title: 'Education & Healthcare Security - SGA Security Uganda',
  description: 'Specialized security services for schools, colleges, universities, hospitals, and healthcare facilities in Uganda. Ensuring safe learning and healing environments for students, patients, and staff.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroTitle="Protecting Uganda's Future Leaders and Healthcare"
        heroDescription="Specialized security services for educational institutions and healthcare facilities across Uganda. We create safe learning and healing environments where students and patients can focus without security concerns."
