...
export const metadata = {
  title: 'Education & Schools Security - SGA Security Uganda',
  description: 'Specialized security services for schools, colleges, and universities in Uganda. Ensuring safe learning environments for students and staff with campus security and student safety programs.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroTitle="Protecting Uganda's Future Leaders"
        heroDescription="Specialized security services for educational institutions across Uganda. We create safe learning environments where students can focus on their education without security concerns."
