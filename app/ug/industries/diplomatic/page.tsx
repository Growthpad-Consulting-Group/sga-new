...
export const metadata = {
  title: 'Diplomatic & Government Security - SGA Security Uganda',
  description: 'High-level security services for diplomatic missions, government facilities, and international organizations in Uganda. Protecting sensitive operations and personnel with specialized security solutions.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="High-level security services for diplomatic missions, government facilities, and international organizations across Uganda. We protect sensitive operations and personnel with specialized security solutions."
