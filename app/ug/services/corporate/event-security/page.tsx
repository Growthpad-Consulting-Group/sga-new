...
export const metadata = {
  title: 'Event Security Services - SGA Security Uganda',
  description: 'Professional event security services for corporate events, conferences, and gatherings in Uganda. Comprehensive security solutions for your events.',
}
  ...
  return (
    <>
      <ServicePageTemplate countryCode="ug" 
        ...
        heroDescription="Our event security services provide comprehensive protection for corporate events, conferences, meetings, and gatherings. With trained security personnel and professional planning, we ensure your events are secure and safe across Uganda."
