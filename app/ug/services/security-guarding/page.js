...
export const metadata = {
  title: 'Security Guarding Services - SGA Security Uganda',
  description: 'Professional on-site security personnel trained to protect your business assets and ensure safety in Uganda. 24/7 security guarding services for corporate clients.',
}
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroDescription="Our trained security guards provide round-the-clock protection for your business premises, assets, and personnel. With extensive experience and rigorous training, our security personnel are equipped to handle various security challenges across Uganda."
