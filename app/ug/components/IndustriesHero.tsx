...
export default function IndustriesHero({ countryCode = 'ug', imageUrl }: IndustriesHeroProps) {
  const country = (countryData as Record<string, any>)[countryCode] || countryData.ug
