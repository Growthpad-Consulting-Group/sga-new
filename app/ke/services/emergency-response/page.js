...
export const metadata = {
  title: 'Emergency Response Services - SGA Security Kenya',
  description: '24/7 rapid response teams ready to handle security incidents immediately in Kenya. Professional emergency response services.',
}
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroDescription="Our emergency response service provides 24/7 rapid deployment of trained response teams to handle security incidents immediately. When emergencies occur, our teams are ready to respond quickly and professionally across Kenya."
        ...
        relatedServices={[
          ...
          },
          {
            ...
            link: '/ke/services/personal-panic-app',
          },
        ]}
      />
      <FloatingWhatsApp 
