...
export const metadata = {
  title: 'Event Security Services - SGA Security Kenya',
  description: 'Professional event security services for corporate events, conferences, and gatherings in Kenya. Comprehensive security solutions for your events.',
}
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroDescription="Our event security services provide comprehensive protection for corporate events, conferences, meetings, and gatherings. With trained security personnel and professional planning, we ensure your events are secure and safe across Kenya."
