...
export const metadata = {
  title: 'Security Guarding Services - SGA Security Kenya',
  description: 'Professional on-site security personnel trained to protect your business assets and ensure safety in Kenya. 24/7 security guarding services for corporate clients.',
}
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroDescription="Our trained security guards provide round-the-clock protection for your business premises, assets, and personnel. With extensive experience and rigorous training, our security personnel are equipped to handle various security challenges across Kenya."
        ...
        countryCode="ke"
        whyChooseTitle="Why Choose Our Security Guarding"
        whyChooseDescription="Our security guarding services stand out through our commitment to professionalism, training, and reliability for corporate clients."
        whyChoosePoints={[
          {
            title: 'Experienced Team',
            description: 'Our guards bring years of experience and are continuously trained on the latest security practices.',
          },
          {
            title: 'Reliable Coverage',
            description: 'Consistent staffing with backup personnel to ensure uninterrupted security coverage.',
          },
          {
            title: 'Business Integration',
            description: 'Security solutions that integrate seamlessly with your business operations.',
          },
        ]}
        relatedServices={[
          {
          ...
          },
          {
            ...
            link: '/ke/services/emergency-response',
          },
          {
