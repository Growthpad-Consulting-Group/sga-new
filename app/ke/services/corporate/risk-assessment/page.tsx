...
export const metadata = {
  title: 'Risk Assessment Services - SGA Security Kenya',
  description: 'Comprehensive security risk assessments for businesses in Kenya. Identify vulnerabilities and develop customized security strategies.',
}
  ...
  return (
    <>
      <ServicePageTemplate countryCode="ke" 
        ...
        heroDescription="Our risk assessment services provide thorough analysis of your business security vulnerabilities. We identify potential threats and develop customized security strategies to protect your assets and operations across Kenya."
        ...
        relatedServices={[
          ...
          },
          {
            ...
            link: '/ke/services/corporate/consulting-services',
          },
        ]}
      />
      <FloatingWhatsApp 
