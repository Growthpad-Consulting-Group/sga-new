...
export const metadata = {
  title: 'Security Consulting Services - SGA Security Kenya',
  description: 'Expert security consulting services for businesses in Kenya. Develop customized security strategies and solutions.',
}
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroDescription="Our security consulting services provide expert guidance to develop customized security strategies for your business. We work with you to design comprehensive security solutions tailored to your specific needs across Kenya."
