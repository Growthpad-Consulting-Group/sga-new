...
export const metadata = {
  title: '24/7 Monitoring Services - SGA Security Kenya',
  description: 'Round-the-clock security monitoring services in Kenya. Continuous surveillance and immediate response to security alerts.',
}
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroDescription="Our 24/7 monitoring service provides round-the-clock surveillance of your security systems. With our state-of-the-art monitoring center, we ensure immediate response to any security alerts, keeping your property protected at all times across Kenya."
