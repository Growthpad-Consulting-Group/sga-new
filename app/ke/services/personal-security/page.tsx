...
export const metadata = {
  title: 'Personal Security Services - SGA Security Kenya',
  description: 'Professional personal security services to protect individuals and families in Kenya. Bodyguards, close protection, and personal safety solutions.',
}
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroDescription="Our personal security services provide dedicated protection for individuals and families. With trained security personnel and advanced technology, we ensure your personal safety and peace of mind across Kenya."
        ...
        countryCode="ke"
        whyChooseTitle="Why Choose Our Personal Security"
        whyChooseDescription="Our personal security services provide professional, reliable protection tailored to your needs."
        whyChoosePoints={[
          {
            title: 'Trained Professionals',
            description: 'Highly trained security personnel with expertise in close protection.',
          },
          {
            title: 'Customized Service',
            description: 'Personalized security solutions designed for your specific needs and lifestyle.',
          },
          {
            title: 'Comprehensive Protection',
            description: 'Complete security coverage for all aspects of your daily life.',
          },
        ]}
        relatedServices={[
          {
            ...
            link: '/ke/services/home-security',
          },
          {
          ...
          },
          {
            ...
            link: '/ke/services/24-7-monitoring',
          },
        ]}
      />
      <FloatingWhatsApp 
