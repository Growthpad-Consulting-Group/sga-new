...
export const metadata = {
  title: 'Manufacturing Security - SGA Security Kenya',
  description: 'Industrial security for manufacturing facilities, warehouses, and production sites in Kenya. Protecting assets, inventory, and ensuring workplace safety.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Comprehensive industrial security solutions for manufacturing facilities, warehouses, and production sites across Kenya. We protect your assets, inventory, and ensure workplace safety."
