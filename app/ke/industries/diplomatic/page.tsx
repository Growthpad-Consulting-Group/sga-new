...
export const metadata = {
  title: 'Diplomatic & Government Security - SGA Security Kenya',
  description: 'High-level security services for diplomatic missions, government facilities, and international organizations in Kenya. Protecting sensitive operations and personnel with specialized security solutions.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="High-level security services for diplomatic missions, government facilities, and international organizations across Kenya. We protect sensitive operations and personnel with specialized security solutions."
