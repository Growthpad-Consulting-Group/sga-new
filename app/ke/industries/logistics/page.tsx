...
export const metadata = {
  title: 'Logistics & Transportation Security - SGA Security Kenya',
  description: 'Security services for logistics companies, warehouses, and transportation hubs in Kenya. Protecting goods in transit and securing distribution centers.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Comprehensive security solutions for logistics companies, warehouses, and transportation hubs across Kenya. We protect goods in transit and secure distribution centers."
