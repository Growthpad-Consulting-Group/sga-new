...
export const metadata = {
  title: 'Residential Estates & Apartments Security - SGA Security Kenya',
  description: 'Comprehensive security solutions for gated communities, residential estates, and apartment complexes in Kenya. 24/7 guarding, access control, CCTV monitoring, and rapid response.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Comprehensive security solutions for gated communities, residential estates, and apartment complexes across Kenya. We provide round-the-clock protection that gives residents peace of mind."
