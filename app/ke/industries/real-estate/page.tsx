...
export const metadata = {
  title: 'Real Estate & Offices Security - SGA Security Kenya',
  description: 'Comprehensive security solutions for office buildings, commercial properties, and real estate developments in Kenya. Protecting tenants, assets, and property value with professional security services.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Comprehensive security solutions for office buildings, commercial properties, and real estate developments across Kenya. We protect tenants, assets, and property value with professional security services."
        ...
        relatedServices={[
          ...
          },
          {
            ...
            link: '/ke/services/alarm-response',
          },
        ]}
      />
      <FloatingWhatsApp 
