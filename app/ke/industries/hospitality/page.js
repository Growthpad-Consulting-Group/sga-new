...
export const metadata = {
  title: 'Hospitality & Holiday Homes Security - SGA Security Kenya',
  description: 'Security solutions for hotels, resorts, and holiday properties in Kenya. Ensuring guest safety and protecting hospitality assets with discreet, professional security services.',
}
  ...
  return (
    <>
      <IndustryPageTemplate
        ...
        heroDescription="Professional security services for hotels, resorts, and holiday properties across Kenya. We ensure guest safety while maintaining the welcoming atmosphere that defines exceptional hospitality."
