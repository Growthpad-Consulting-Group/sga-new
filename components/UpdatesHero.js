...
export default function UpdatesHero({ imageUrl = '/images/contact/hero.png' }) {
  return (
    <section id="hero" className="bg-gray-100 text-dark-charcoal pt-16 sm:pt-20 pb-0">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-xl md:text-2xl lg:text-3xl font-bold">
            <span className="text-primary-orange">Latest Updates From SGA Security</span>
          </h1>
        </motion.div>
      </div>
      ...
      <div className="w-full">
        ...
        >
          <Image
            src={imageUrl}
            alt="SGA Security Group - Updates"
            fill
