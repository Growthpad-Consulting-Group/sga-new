 ...
 */
function getCountryUrl(countryCode: string, pathname: string, isSubdomainEnabled: boolean): string {
 ...
 */
function getCurrentCountry(pathname: string, hostname: string): string | null {
...
export default function CountrySwitcher(): React.JSX.Element {
  ...
  const isActive = (countryCode: string) => {
